...
var dist = __webpack_require__(9715);
...
async function middleware(req) {
    ...
    if (publicRoutes.includes(pathname) || pathname.includes("/_next/") || pathname.includes("/api/") || pathname.includes("/course-thumbnails/")) {
...
var import_auth_helpers_shared = __webpack_require__(8838);
var supabase;
function createClientComponentClient({ supabaseUrl = "https://ojhhzwqjngcjpnzwgefn.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9qaGh6d3FqbmdjanBuendnZWZuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQzMDAzMDksImV4cCI6MjA1OTg3NjMwOX0.QJII-Ji7bdtWjhawbxDIEj8jDhU3THUTnEJxcelXdrI", options, cookieOptions, isSingleton = true } = {}) {
...
var import_auth_helpers_shared2 = __webpack_require__(8838);
var import_set_cookie_parser = __webpack_require__(2718);
...
function createPagesServerClient(context, { supabaseUrl = "https://ojhhzwqjngcjpnzwgefn.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9qaGh6d3FqbmdjanBuendnZWZuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQzMDAzMDksImV4cCI6MjA1OTg3NjMwOX0.QJII-Ji7bdtWjhawbxDIEj8jDhU3THUTnEJxcelXdrI", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared3 = __webpack_require__(8838);
var import_set_cookie_parser2 = __webpack_require__(2718);
...
function createMiddlewareClient(context, { supabaseUrl = "https://ojhhzwqjngcjpnzwgefn.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9qaGh6d3FqbmdjanBuendnZWZuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQzMDAzMDksImV4cCI6MjA1OTg3NjMwOX0.QJII-Ji7bdtWjhawbxDIEj8jDhU3THUTnEJxcelXdrI", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared4 = __webpack_require__(8838);
...
function createServerComponentClient(context, { supabaseUrl = "https://ojhhzwqjngcjpnzwgefn.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9qaGh6d3FqbmdjanBuendnZWZuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQzMDAzMDksImV4cCI6MjA1OTg3NjMwOX0.QJII-Ji7bdtWjhawbxDIEj8jDhU3THUTnEJxcelXdrI", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared5 = __webpack_require__(8838);
...
function createRouteHandlerClient(context, { supabaseUrl = "https://ojhhzwqjngcjpnzwgefn.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9qaGh6d3FqbmdjanBuendnZWZuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQzMDAzMDksImV4cCI6MjA1OTg3NjMwOX0.QJII-Ji7bdtWjhawbxDIEj8jDhU3THUTnEJxcelXdrI", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = "https://ojhhzwqjngcjpnzwgefn.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9qaGh6d3FqbmdjanBuendnZWZuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQzMDAzMDksImV4cCI6MjA1OTg3NjMwOX0.QJII-Ji7bdtWjhawbxDIEj8jDhU3THUTnEJxcelXdrI", options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = "https://ojhhzwqjngcjpnzwgefn.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9qaGh6d3FqbmdjanBuendnZWZuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQzMDAzMDksImV4cCI6MjA1OTg3NjMwOX0.QJII-Ji7bdtWjhawbxDIEj8jDhU3THUTnEJxcelXdrI", options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = "https://ojhhzwqjngcjpnzwgefn.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9qaGh6d3FqbmdjanBuendnZWZuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQzMDAzMDksImV4cCI6MjA1OTg3NjMwOX0.QJII-Ji7bdtWjhawbxDIEj8jDhU3THUTnEJxcelXdrI", options, cookieOptions } = {}) {
...
class RealtimeClient {
     ...
     */ connect() {
        ...
        Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 5576, 23)).then(({ default: WS })=>{
...
/******/ var __webpack_exports__ = (__webpack_exec__(4519));
